                    ...
                    <div className="flex w-full justify-between items-center py-5">
                        <nav className="px-4">
                            <ul className="flex gap-2 items-center">
                                ...
                                <li><Link className="p-1 rounded hover:bg-neutral-100" to={`/category/${postData?.category}`}>{Capitalize(postData?.category)}</Link></li>
                                <li className="hidden lg:block text-neutral-400">|</li>
                                <li className="hidden lg:block text-neutral-600">{postData?.title}</li>
                            </ul>
                        </nav>
                        <Link to={`/`} className={`flex items-center justify-between w-auto hover:text-neutral-600 `}>
