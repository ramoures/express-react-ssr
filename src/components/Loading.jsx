        ...
        <>
            {n > 0 &&
                <div className="flex flex-col justify-start items-start gap-4">
                    {[...Array(n)].map((x, i) => {
                        return (
                            <div key={`ld_${i}`} className="w-full h-72 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 justify-center items-center px-8">
            ...
            {n <= 0 &&
                <div className="flex flex-col justify-start items-start gap-4 h-screen py-6">
                    ...
                    <div key={`ld_0`} className="w-full h-auto grid grid-cols-1 gap-3 justify-center items-center px-8">
                        <div key={`ld_0_1`} className="w-full min-h-[500px] bg-neutral-200 animate-pulse duration-75 ease-linear block rounded-3xl "></div>
