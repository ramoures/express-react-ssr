        ...
        <header id="navbar" className="w-full bg-gradient-to-r from-slate-400/50 from-0% via-20% to-60% via-teal-200/50 to-slate-400/50 p-4 flex items-center justify-center border-b-[6px] border-neutral-200  sticky top-0 z-50 backdrop-blur-md">
            <div className="w-full xl:w-10/12 2xl:w-8/12 flex justify-between ">
                <div className="flex gap-2 items-center">
                    ...
                    <a target="_blank" rel="noreferrer" className="opacity-100 hover:opacity-80 text-teal-600" href="https://github.com/ramoures/express-react-ssr">
                ...
                <div className="flex items-center gap-3">
                    {sign &&
                        <>
                            <div className="hidden sm:flex text-sm items-center gap-2 bg-slate-100 p-2 rounded-sm">
                                <div className="">Hi! John</div>
                                -
                                <button onClick={singOut} className="text-xs text-blue-800">Sign out</button>
                            </div>
                            <button onClick={singOut} className="sm:hidden bg-slate-100/80 p-1 rounded-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-box-arrow-right text-neutral-600" viewBox="0 0 16 16">
                    ...
                    {!sign &&
                        <div id="headerSingIn" className="flex text-sm items-center gap-2 bg-slate-100 p-2 rounded-sm">
